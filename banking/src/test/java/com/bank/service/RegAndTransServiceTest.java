...
class RegAndTransServiceTest {
    ...
    void testRegisterAccountSuccess() {
        ...
        verify(transactionRepository).save(argThat(txn ->
                txn.getOccurredFor().equals(123456789L) &&
                        ...
                        txn.getTxnType() == TransactionType.DEPOSIT &&
    ...
    @Test
    void getBankStmnt() {
        TransactionHistory transactionHistory = new TransactionHistory(1L, "TXN6735486", 645445464L, 5464564L, new Date(), 5368.00, TransactionType.DEPOSIT, 3000000.00);
    ...
    void shoppingPayment(){
        ...
        service.makeShoppingPayment(paymentRequest);
    }
